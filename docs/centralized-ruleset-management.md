# Centralized Ruleset Management - AI-SDLC v2.7.1
...
cat > ~/Documents/Cline/Rules/thecreditpros-master-v2.7.1.md << 'EOF'
# TheCreditPros Master Development Rules v2.7.1
...
# Customer Frontend Portal Specific Rules v2.7.1
...
# Portal 2 Refactor (Laravel) Specific Rules v2.7.1
...
for dev in "${DEVELOPERS[@]}"; do
    ...
    # Copy master rules
    scp "$RULES_SOURCE/thecreditpros-master-v2.7.1.md" "$dev@workstation:~/Documents/Cline/Rules/"
...
# $repo Specific Rules v2.7.1

## Include Global Rules
@include ~/Documents/Cline/Rules/thecreditpros-master-v2.7.1.md
...
- **Minor (v2.7.1)**: New rules or significant policy changes
- **Patch (v2.7.1)**: Bug fixes or clarifications
