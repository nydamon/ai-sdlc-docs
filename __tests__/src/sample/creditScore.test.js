...
const { calculateCreditScore, isValidCreditScore, getCreditScoreRange } = require('../../../src/sample/creditScore');

describe('Credit Score Calculation Module', () => {
  describe('calculateCreditScore', () => {
    it('should throw an error if no creditData is provided', () => {
      expect(() => calculateCreditScore()).toThrow('Invalid credit data provided');
    });

    it('should throw an error if creditData is not an object', () => {
      expect(() => calculateCreditScore('not an object')).toThrow('Invalid credit data provided');
    });
    ...
    it('should calculate the correct credit score', () => {
      ...
      expect(calculateCreditScore(creditData)).toBe(725);
    });
